...
\begin{figure}[!h]
	\centering
	\subfigure[]{\includegraphics[width=6cm]{../figures/LMS.pdf}}
	\subfigure[]{\includegraphics[width=6cm]{../figures/closed.pdf}}
	\caption{Optimization using the LMS-rule with online learning (a) and in closed form (b)}
	\label{fig:122_LMS}
\end{figure}
The values of the resulting weight vector are summarized in Tab.~\ref{table:wLMS} and the corresponding curves plotted in Fig.~\ref{fig:122_LMS}.
