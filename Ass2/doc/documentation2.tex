...
\begin{figure}[h!]
\centering
	\subfigure[$\sigma=0.5$]{\includegraphics[width=5cm]{../figures/sv_kernel5.pdf}}
	\subfigure[$\sigma=0.15$]{\includegraphics[width=5cm]{../figures/sv_kernel15.pdf}}
	\subfigure[$\sigma=0.25$]{\includegraphics[width=5cm]{../figures/sv_kernel25.pdf}}
	\\
	\subfigure[$\sigma=0.35$]{\includegraphics[width=5cm]{../figures/sv_kernel35.pdf}}
	\subfigure[$\sigma=0.45$]{\includegraphics[width=5cm]{../figures/sv_kernel45.pdf}}
	\subfigure[$\sigma=0.55$]{\includegraphics[width=5cm]{../figures/sv_kernel55.pdf}}
